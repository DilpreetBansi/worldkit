"""Manipulation benchmark tasks: pushing, stacking objects."""
...
class _ManipulationTask(BenchmarkTask):
    """Base class for manipulation benchmark tasks."""
    ...
    def evaluate(self, model, episodes: int = 50, seed: int = 42) -> TaskResult:
        """Evaluate model on this manipulation task."""
...
class PushTTask(_ManipulationTask):
...
class BlockStackTask(_ManipulationTask):
    """Stack blocks in the correct order."""
